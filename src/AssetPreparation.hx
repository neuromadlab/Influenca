...
typedef Registration = {
	...
	var inf_text5:String;
	var inf_text6:String;
...
class AssetPreparation {
	...
	static public function initializeLanguage(language_json_savepath:String):Language {
			...
			var language_json = Assets.getText(language_json_savepath);
	...
	/*static public function loadImageAsync(imagepath:String):Bitmap {
		
		var asset_bd = Assets.loadBitmapData(imagepath)
			.onComplete(
				function(asset_bd){
